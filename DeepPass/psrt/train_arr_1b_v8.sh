...
# ARR-PSRT 1.1B v8: Gradual routing transition + frozen backbone
# K=2 + uniform routing for 500 steps, then gradually introduce K=3 + learned routing
cd /blue/cis4914/jietao/DeepPass
export LD_PRELOAD=/blue/cis4914/jietao/DeepPass/envs/deeppass/lib/libstdc++.so.6
echo "=== ARR-PSRT 1.1B v8 ===" && echo "Started: $(date)"
