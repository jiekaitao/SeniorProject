...
# ARR-PSRT 1.1B v9: Soft routing in Phase B (no hard top-k masking)
# Root cause fix: hard top-k zeros cause NaN in backward pass
cd /blue/cis4914/jietao/DeepPass
export LD_PRELOAD=/blue/cis4914/jietao/DeepPass/envs/deeppass/lib/libstdc++.so.6
echo "=== ARR-PSRT 1.1B v9 (soft routing) ===" && echo "Started: $(date)"
