...
#SBATCH --qos=cis4914
#SBATCH --output=/blue/cis4914/jietao/DeepPass/results/sbatch_expa_L16_%j.log
#SBATCH --job-name=expa

# Experiment A variant: Replay layers 16-19 instead of 12-15
# Tests whether later layers benefit more from replay
cd /blue/cis4914/jietao/DeepPass
export LD_PRELOAD=/blue/cis4914/jietao/DeepPass/envs/deeppass/lib/libstdc++.so.6
echo "=== Exp A (layers 16-19) ===" && echo "Started: $(date)"
...
model = BandRecurrentLlama(base_model, replay_layer_ids=(16, 17, 18, 19), lora_rank=16, max_extra_passes=1)
