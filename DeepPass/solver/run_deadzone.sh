#!/bin/bash
#SBATCH --job-name=deadzone
#SBATCH --output=/blue/cis4914/jietao/DeepPass/results/sbatch_deadzone_%j.log
...
# Confirm L13 and L15 also have dips? Plus investigate L18 more
echo "=== Dead zone investigation: L13, L15 more seeds + L18, L19 deeper ==="
for L in 13 15 18 19; do
